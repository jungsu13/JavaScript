...
// 자바스크립트 객체기반 언어
// 객체는 속성과 기능을 가진다.
// phone 속성(property 도시락육면체) - color, size
// phone 기능(method 정육면체) - ring, take a picture, play music
// 형식 { 키 : 값, 키2 : 값 } 다수일때 ,로 추가


// 객체의 종류
// 내장객체 : 문자(String), 날짜(Date), 배열(Array), 수학(Math) 등등....
// 브라우저 객체 모델(BOM) : window, screen, location, history, navigator네비게이션
...
const user = {
    ...
    works : [
        ...
        {id:3, title:'우는 연인', price:50000, like:200},
    ],
